...
<body>
<div class="limiter">
    <div class="container-login100" style="background-image: url('<?=_SERVER_._STYLES_F_?>assets/img/fachada.jpg');width: 60%; float: left; background-size: cover"></div>
    <div class="container-login100" style="width: 40%; background: #005bea; background: -webkit-linear-gradient(bottom,#6DDFA9,#598AC1); background: -o-linear-gradient(bottom, #6a0c0d,#dfa974); background: -moz-linear-gradient(bottom, #6a0c0d,#dfa974); background: linear-gradient(bottom, #6a0c0d,#dfa974); opacity: 0.9"">
        <div class="wrap-login100 p-t-190 p-b-30">
            <div class="login100-form validate-form">
                <div class="login100-form-avatar">
                    <img src="<?=_SERVER_._STYLES_F_?>assets/img/Quispe-Oficial-removebg.png" alt="Logo de Proyecto">
                </div>
                <span class="login100-form-title p-t-20 p-b-45">TIENDA VIRTUAL QUISPE</span>
