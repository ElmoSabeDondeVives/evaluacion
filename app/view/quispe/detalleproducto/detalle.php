    ...
    <div class="custom-container">
        <div class="nav_block">
            ...
            <ul class="navbar-nav attr-nav align-items-center">
                ...
                <li class="dropdown cart_dropdown"><a class="nav-link cart_trigger" href="#" data-toggle="dropdown"><i class="linearicons-bag2"></i><span class="cart_count">2</span><span class="amount"><span class="currency_symbol">S/</span>159.00</span></a>
                    <div class="cart_box cart_right dropdown-menu dropdown-menu-right">
                        <ul class="cart_list">
                            <li>
                                <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                <a href="#"><img src="<?= _SERVER_._STYLES_F_ ?>assets/images/cart_thamb1.jpg" alt="cart_thumb1">Producto 01</a>
                                <span class="cart_quantity"> 1 x <span class="cart_amount"> <span class="price_symbole">S/</span></span>78.00</span>
                            </li>
                            <li>
                                <a href="#" class="item_remove"><i class="ion-close"></i></a>
                                <a href="#"><img src="<?= _SERVER_._STYLES_F_ ?>assets/images/cart_thamb2.jpg" alt="cart_thumb2">Producto 02</a>
                        ...
                        <div class="cart_footer">
                            ...
                            <p class="cart_buttons"><a href="#" class="btn btn-fill-line view-cart">Ver Carrito</a><a href="#" class="btn btn-fill-out checkout">Verificar</a></p>
                        </div>
                    </div>
                </li>
            </ul>
...
<div class="main_content">
    <!-- START SECTION SHOP -->
    <div class="section" style="padding: 20px !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-4 mb-md-0">
                    <div class="product-image vertical_gallery">
                        <div id="pr_item_gallery" class="product_gallery_item slick_slider" data-vertical="true" data-vertical-swiping="true" data-slides-to-show="5" data-slides-to-scroll="1" data-infinite="false">
                            <div class="item">
                                <a href="#" class="product_gallery_item active" data-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" data-zoom-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg">
                                    <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" alt="product_small_img1" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="#" class="product_gallery_item" data-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" data-zoom-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg">
                                    <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" alt="product_small_img2" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="#" class="product_gallery_item" data-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" data-zoom-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg">
                                    <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" alt="product_small_img3" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="#" class="product_gallery_item" data-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" data-zoom-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg">
                                    <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" alt="product_small_img4" />
                                </a>
                            </div>
                            <div class="item">
                                <a href="#" class="product_gallery_item active" data-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" data-zoom-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg">
                        ...
                        <div class="product_img_box">
                            <img id="product_img" src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" data-zoom-image="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img9.jpg" alt="product_img1" />
                                    ...
                                    <ul class="list_none comment_list mt-4">
                                        <li>
                                            <div class="comment_img">
                                                <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/cart_thamb1.jpg" alt="user1"/>
                                            </div>
                                        ...
                                        <li>
                                            <div class="comment_img">
                                                <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/cart_thamb1.jpg" alt="user2"/>
                                            </div>
                                            <div class="comment_block">
                                                <div class="rating_wrap">
                                                    <div class="rating">
                    ...
                    <div class="releted_product_slider carousel_slider owl-carousel owl-theme" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
                        <div class="item">
                            <div class="product">
                                <div class="product_img">
                                    <a href="#">
                                        <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img3.jpg" alt="product_img1">
                                    </a>
                        ...
                        <div class="item">
                            <div class="product">
                                <div class="product_img">
                                    <a href="#">
                                        <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img3.jpg" alt="product_img2">
                                    </a>
                                    <div class="product_action_box">
                                        <ul class="list_none pr_action_btn">
                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="product_img">
                                    <a href="#">
                                        <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img3.jpg" alt="product_img3">
                                    </a>
                                    <div class="product_action_box">
                                        <ul class="list_none pr_action_btn">
                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                        ...
                        <div class="item">
                            <div class="product">
                                <div class="product_img">
                                    <a href="#">
                                        <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img3.jpg" alt="product_img4">
                                    </a>
                                    <div class="product_action_box">
                                        <ul class="list_none pr_action_btn">
                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                        ...
                        <div class="item">
                            <div class="product">
                                <div class="product_img">
                                    <a href="#">
                                        <img src="<?= _SERVER_._STYLES_ASSETS_ ?>images/el_hover_img3.jpg" alt="product_img5">
                                    </a>
                                    <div class="product_action_box">
                                        <ul class="list_none pr_action_btn">
                                            <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
