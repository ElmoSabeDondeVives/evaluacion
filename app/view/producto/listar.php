						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form-group">
									<div class="row">
										<div class="col-lg-12">
											<label for="id_subcategoria" class="col-form-label">Indicar SubCategoría</label>
											<select class="form-control" id="id_subcategoria" name="id_subcategoria" onchange="traer_marcas()">
												<option value="">Escoger </option>
												<?php
												foreach ($subcategoria as $s){
													?>
													<option value="<?= $s->id_subcategoria;?>"><?= $s->subcategoria_nombre;?></option>
													<?php
												}
												?>
											</select>
										...
										<div class="col-lg-4">
											...
											<input class="form-control" type="text" id="producto_descuento" name="producto_descuento" maxlength="100" oninput="calcularPrecioAntiguo_ProductoListar()">
										</div>
										<div class="col-lg-4">
										...
										<div class="col-lg-6">
                                            ...
                                            <div class="input-group" style="width: 55%">
                                                <button type="button" class="btn btn-sm btn-info" onclick="disminuirValoracion_ProductoListar('producto_valoracion', 0.5)"><i class="fa fa-arrow-left"></i></button>
                                                <input value="4.5" class="form-control" type="text" id="producto_valoracion" name="producto_valoracion">
                                                <button type="button" class="btn btn-sm btn-info" onclick="aumentarValoracion_ProductoListar('producto_valoracion', 0.5)"><i class="fa fa-arrow-right"></i></button>
                                            </div>
										</div>
										<div class="col-lg-6">
...
<!-- Modal ver imagen-->
<div class="modal fade" id="modalver" tabindex="-1" aria-labelledby="eder" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="" id="mostrarimg" width="400" height="380px">
			</div>
			<div class="modal-footer">
		...
		<div class="col-lg-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h5 style="font-size: 20px; color: #3487C9 !important" class="m-0 font-weight-bold text-primary">LISTA DE TODOS LOS PRODUCTOS REGISTRADOS</h5>
					<button style="float: right; position: relative; margin-top: -28px" data-toggle="modal" data-target="#gestionProducto" onclick="limpiar_ProductoLimpiar()" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> Agregar Nuevo</button>
				</div>
				<div class="card-body">
...
<!--									<td>-->
<!--										--><?php //= $m->usuario_nickname;?><!--<br>-->
<!--										--><?php //= $m->producto_creacion;?>
<!--									</td>-->
                                    <td>
                                        Producto:<br><?=$m->codigo_barra_producto;?><br>
                                        Sistema:<br><?=$m->codigo_barra_sistema;?>
                                    </td>
									<td>
										<?php
...
<script src="<?php echo _SERVER_ . _JS_;?>productolistar.js"></script>
