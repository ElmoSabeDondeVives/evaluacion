...
$("#formulario_producto").on('submit', function(e){
    ...
    valor = validar_campo_vacio('id_subcategoria',id_subcategoria, valor);
    valor = validar_campo_vacio('producto_estado',producto_estado, valor);
    if(valor){
        $.ajax({
            type: "POST",
            url: urlweb + "api/Producto/guardar_producto_listar",
...
function editarproducto(id_producto){
    ...
    $.ajax({
        ...
        $('#producto_precio').val(almacenar.producto_precio);
        $('#id_subcategoria').val(almacenar.id_subcategoria);
    ...
    function edicion(producto_nombre, producto_precio, id_subcategoria, producto_stock, producto_descuento, producto_precioantiguo, producto_marca, producto_reseña, producto_caracteristicas, producto_detalle, producto_valoracion, producto_imagen, producto_estado){
...
function calcularPrecioAntiguo_ProductoListar(){
...
function aumentarValoracion_ProductoListar(inputId, cantidad){
...
function disminuirValoracion_ProductoListar(inputId, cantidad) {
    var input = document.getElementById(inputId)
    var valoracion = parseFloat(input.value);
...
function limpiar_ProductoLimpiar(){
    $('#id_subcategoria').val('');
    $('#producto_nombre').val('');
