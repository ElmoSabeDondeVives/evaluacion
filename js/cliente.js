...
function gestionar_cliente(){
    ...
    var id_actualizar_cliente = $("#id_actualizar_cliente").val();
            ...
            success:function (r) {
                ...
                switch (r.result.code) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        respuesta('El cliente ya se encuentra registrado', 'error');
                        break;
                    default:
...
function botoneditar(id_cliente){
    // $('#gestionProducto').modal('show');
    let guardarid = id_cliente;
    $.ajax({
        type: "POST",
        url: urlweb + "api/Cliente/botoneditar",
        data: {
            guardarid :guardarid
        },
        dataType: 'json'
        ...
        $("#id_actualizar_cliente").val(guardarid);
        $("#cliente_nombre").val(almacenar.cliente_nombre);
        $("#cliente_numero").val(almacenar.cliente_numero);
        $("#cliente_correo").val(almacenar.cliente_correo);
    });
function edicion(cliente_nombre, cliente_numero, cliente_correo){
