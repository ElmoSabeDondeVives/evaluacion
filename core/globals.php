...
define('_SERVER_', 'http://localhost:8080/quispeback/');
define('_STYLES_F_', 'styles_f/');
//Definicion de variables para conexion de base de datos
define('_SERVER_DB_', 'sql305.infinityfree.com');
define('_STYLES_bt5_', 'styles/bt5/');
define('_DB_', 'if0_34386153_quispe');
define('_USER_DB_', 'if0_34386153');
define('_PASSWORD_DB_', 'YjfpTFwkAW');

//Definicion de clave de desencriptacion
define('_FULL_KEY_','ñklmqz');
//Titulo
define('_TITLE_', 'Quispe');
//Rutas de Archivos
...
define('_STYLES_ASSETS_', 'styles_f/assets/');
define('_ICON_', 'styles_f/assets/img/SESION.png');
define('_JS_','js/');
